...
class Timer:
    ...
    def stop(self):
        ...
        # print(f"Total time: {self.totalTime:0.2f} seconds")
        # print("Start time: ", time.ctime(self.startTimer))
        # print("Stop time: ", time.ctime(self.stopTimer))
        print("timer test results - it passed")
        #clear the timer
        # self.startTimer = None
        # self.stopTimer = None
